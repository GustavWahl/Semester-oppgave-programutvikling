...
/**
 * Flamethrower represents an new enemy type
 *
 * @author gustav Wahl
 */
...
public class Flamethrower extends GameObject{
     ...
     */
        ...
        public Flamethrower(int hp,boolean alive, Node view, double posX, double posY){
            super(view);
            this.hp = hp;
            this.alive = alive;
            this.posX = posX;
    ...
    /**
     * Decides the state of the Flamethrower, what the enemy does.
     * It runs a method that constatly runs. Gets called from animation timer.
     *
     * @param object is the player in the game
     * @param object2 the Flamethrower
     */
        public void FSM (GameObject object , Flamethrower object2) {
     ...
     */
        public void StateShoot(GameObject object, Flamethrower object2) {
     ...
     */
        ...
        public void StateWalk(GameObject object, Flamethrower object2) {
